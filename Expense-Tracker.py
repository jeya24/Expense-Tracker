...
def remove_all_expenses():
    ...
    if surety:
        ...
        list_all_expenses()
        mb.showinfo(
            "All Expenses deleted", "All the expenses were successfully deleted"
        )
    else:
...
dataentery_frame_bg = "LightBlue"
buttons_frame_bg = "White"
hlb_btn_bg = "LightGrey"
...
Label(
    root, text="EXPENSE TRACKER", font=("Noto Sans CJK TC", 15, "bold"), bg=hlb_btn_bg
...
# Data Entry Frame
Label(
    data_entry_frame, text="Date (M/DD/YY) :", font=lbl_font, bg=dataentery_frame_bg
).place(x=10, y=50)
...
Label(
    data_entry_frame, text="Mode of Payment:", font=lbl_font, bg=dataentery_frame_bg
).place(x=10, y=310)
dd1 = OptionMenu(
    data_entry_frame,
    MoP,
...
Button(
    data_entry_frame,
    text="Convert to words before adding",
    font=btn_font,
    width=30,
    bg=hlb_btn_bg,
).place(x=10, y=450)
...
Button(
    buttons_frame,
    text="Clear Fields in DataEntry Frame",
    font=btn_font,
    width=25,
    bg=hlb_btn_bg,
...
Button(
    buttons_frame,
    text="Convert Expense to a sentence",
    font=btn_font,
    width=25,
    bg=hlb_btn_bg,
